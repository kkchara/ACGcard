  ...
  try {
    ...
    <svg width="467" height="195" viewBox="0 0 467 195" fill="none" xmlns="http://www.w3.org/2000/svg" role="img"
        ...
        <style>
            ...
            to {
                stroke-dashoffset: 33.677963776715295;
            }
            }
        ...
        <g data-testid="card-title" transform="translate(25, 35)">
            ...
            <text x="0" y="0" class="header" data-testid="header">${apiData.name}' 的 ScoreSaber 数据概览</text>
            </g>
        </g>
        ...
        <g data-testid="main-card-body" transform="translate(0, 55)">
            ...
            <g transform="translate(0, 25)">
                ...
                <text class="stat  bold" x="25" y="12.5">全球排名 :</text>
                <text class="stat  bold" x="219.01" y="12.5" data-testid="commits">${apiData.rank}</text>
                </g>
            </g>
            <g transform="translate(0, 50)">
                ...
                <text class="stat  bold" x="25" y="12.5">${apiData.country}地区排名 :</text>
                <text class="stat  bold" x="219.01" y="12.5" data-testid="prs">${apiData.countryRank}</text>
                </g>
            </g>
            <g transform="translate(0, 75)">
                ...
                <text class="stat  bold" x="25" y="12.5">总游玩次数:</text>
                <text class="stat  bold" x="219.01" y="12.5" data-testid="issues">${apiData.scoreStats.totalPlayCount}</text>
                </g>
            </g>
