  ...
  try {
    ...
    const svgString = `
      <svg width="467" height="195" viewBox="0 0 467 195" fill="none" xmlns="http://www.w3.org/2000/svg" role="img"
        ...
        <desc id="descId">Total Stars Earned: 74086, Total Commits in 2024 : 81, Total PRs: 796, Total Issues: 180,
            Contributed to (last year): 3</desc>
        <style>
            .header {
        ...
        <g data-testid="card-title" transform="translate(25, 35)">
            ...
            <text x="0" y="0" class="header" data-testid="header">${apiData.nickname}'s MaiMai Rating</text>
            </g>
        </g>
        ...
        <g data-testid="main-card-body" transform="translate(0, 55)">
            ...
            <g transform="translate(0, 0)">
                ...
                <text class="stat  bold" x="25" y="12.5">Rating:</text>
                <text class="stat  bold" x="219.01" y="12.5" data-testid="stars">${apiData.rating}</text>
                </g>
            </g>
            <g transform="translate(0, 25)">
                ...
                <text class="stat  bold" x="219.01" y="12.5" data-testid="commits">81</text>
                </g>
            </g>
            <g transform="translate(0, 50)">
                ...
                <text class="stat  bold" x="219.01" y="12.5" data-testid="prs">796</text>
                </g>
            </g>
